\begin{tikzpicture}
	...
	\node 	(e2)		at	(3,0) 	[circle, thick, draw=blue!50,fill=green!20,inner sep=0pt,minimum size=.75cm]{$q_1$};


	\node 	(e3)		at	(6,0) 	[circle, thick, draw=blue!50,fill=red!20,inner sep=0pt,minimum size=.75cm]{$q_2$};



%	\node 	(e4)		at	(0,-4) 	[circle, thick, draw=blue!50,fill=green!20,inner sep=0pt,minimum size=.75cm]{$4$};
